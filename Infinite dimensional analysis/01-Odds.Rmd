...
Suppose $R$ is an order relation on $\Omega$, then $\Omega$ is said to be **inductivelt ordered** by $R$ if every totally ordered subset has an **supremum**.

**Zorn's Lemma** states that every inductively ordered set has a maximal element.

```{definition, weelord, name=""}
