...
$2\implies 3$ Suppose $\ker \mathcal{N}(x)$ contains $y$ diifer $x$, that implies any neighborhood contains $x$ and contradict $2$.
...
```{definition, , name=""}
Space $(\Omega,\tau)$ is said to be $T_3$ if it's $T_0$ and regular.
```
...
Then we show that $\sum g_n$ is the extension of $f$.