...
::: {.theorem #doob-inequality name="Doob's inequality"}

Let $M$ be a martingale in $L^{p}$, $\frac{1}{p}+\frac{1}{q}=1$, then
$$
\mathop{{}\mathbb{E}}_{}\sup _{0\le k\le t} \left| M _{k}\right|^{p}\le q ^{p} \mathop{{}\mathbb{E}}_{} \left| M_{t} \right|^{p}
$$
