...
$1 \iff 2$ follows from Inversion formula \@ref(thm:inversion-formula) immediately.
...
$$
\mathop{{}\mathbb{P}}(F)\le \delta\implies \sup_{X\in \mathcal{K}} \mathop{{}\mathbb{E}}|X| \bm{\mathbf{1}}_{F}\le \epsilon
$$
