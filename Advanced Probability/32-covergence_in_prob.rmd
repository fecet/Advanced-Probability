...
Suppose $(X_n)$ are pairwise independent and identical distributed with finite mean $a$ and finite variation $b$. Then $(\overline{X}_n)$ converges to $a$ in $L^2$ and a.s.
