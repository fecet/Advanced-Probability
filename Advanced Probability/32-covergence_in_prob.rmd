...
::: {.theorem #var-cauchy-convergence-probability name=""}
...
Suppose $q_n(u)\to q(u)$ a.s. in $(0,1)$. For $f\in \mathbb{C}_b$, $f\circ q_n \to f\circ q$ a.s. and hence
$$
\mu_n f=\lambda(f\circ q_n)\to \lambda(f \circ q)=\mu f
$$
by DCT \@ref(thm:DCT). That is, $(\mu_n)$ converges to $\mu$ weakly. We should see the condition of convergence a.s. can be loose and the converse also holds.
