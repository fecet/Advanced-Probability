...
::: {.lemma #markov-inequality  name="Markov inequality"}
...
By lemma \@ref(lem:markov-inequality) and define $A_M=\{x\in \Omega:f(x)\ge M\}$. Consequently, $\mu(A_M)=0$ for all $M > 0$, note $A_{\frac{1}{n}}\nearrow A_0$:
