...
Let $(X,\succsim)$ be a convex decision problem then $\succsim$ is independent and continuous iff there is a linear utility function $\overline{u}$ representing $\succsim$.
